...
export default function AdminPage() {
  ...
  // ΓöÇΓöÇΓöÇ RENDER SIDEBAR CONTENT ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  return (
    <div className="h-screen w-screen bg-[#080C14] text-white flex flex-col overflow-hidden">
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ TOP HEADER ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ MAIN BODY: 3-column layout ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b border-slate-800/50 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-500">Hybrid AI ΓÇö Rule + LLM</span>
              </div>
