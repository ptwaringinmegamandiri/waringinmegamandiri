...
const ALL_THEME_KEYS = [
  ...
  // About
  'about_title','about_subtitle','about_profile_text','about_vision','about_mission',
  // Karir
  'karir_title','karir_subtitle','karir_cta_title','karir_cta_desc',
  // News
  'news_title','news_subtitle','news_newsletter_title','news_newsletter_desc',
  // Portfolio
  'portfolio_title','portfolio_subtitle','portfolio_cta_text',
  // Kontak
  'kontak_title','kontak_subtitle','kontak_cta_text',
  // Navbar
  'navbar_brand_text','navbar_cta_text','navbar_logo_url','navbar_logo_width','navbar_logo_height',
  // Footer
