      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-slate-400 text-sm font-body italic mb-2">
              {t('hero.slogan')} — PT Waringin Mega Mandiri
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5 text-sm text-slate-500">
              <li><Link to="/" className="hover:text-sky-400">{t('nav.beranda')}</Link></li>
              <li><Link to="/tentang-kami" className="hover:text-sky-400">{t('nav.tentangKami')}</Link></li>
              <li><Link to="/portofolio" className="hover:text-sky-400">{t('nav.portofolio')}</Link></li>
              <li><Link to="/news" className="hover:text-sky-400">{t('nav.news')}</Link></li>
              <li><Link to="/karir" className="hover:text-sky-400">{t('nav.karir')}</Link></li>
              <li><Link to="/kontak" className="hover:text-sky-400">{t('nav.kontak')}</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-3 text-sm text-slate-500 font-body">
              <p>{t('kontak.addressVal')}</p>
              <p className="text-emerald-400 font-bold">{t('kontak.phoneVal')}</p>
